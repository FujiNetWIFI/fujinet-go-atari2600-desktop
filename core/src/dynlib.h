...
#ifndef A2600_DYNLIB_H
#define A2600_DYNLIB_H
...
typedef HMODULE a2600_dynlib;

static inline a2600_dynlib a2600_dynlib_open(const char *path)
{
...
static inline void *a2600_dynlib_sym(a2600_dynlib h, const char *name)
{
    return (void *)(uintptr_t)GetProcAddress(h, name);
}

static inline const char *a2600_dynlib_error(char *buf, int buflen)
{
