...
; own installer.nsi via fujinet-go-coleco-desktop, renamed for the Atari 2600.
;
...
!endif
!ifndef SRCDIR
  !define SRCDIR "dist\FujiNet-Go-Atari2600"
!endif
!ifndef OUTFILE
  !define OUTFILE "FujiNet-Go-Atari2600-Setup.exe"
!endif
...
!define APPNAME    "FujiNet Go Atari 2600"
!define PUBLISHER  "Thomas Cherryhomes"
!define EXENAME    "fujinet-go-atari2600-windows.exe"
!define HOMEPAGE   "https://fujinet.online/"
!define REGAPP     "Software\FujiNetGoAtari2600"
!define REGUNINST  "Software\Microsoft\Windows\CurrentVersion\Uninstall\FujiNetGoAtari2600"
...
Section "Uninstall"
  ...
  ; Settings and the provisioned FujiNet tree live under %APPDATA%\
  ; fujinet-go-atari2600 and %LOCALAPPDATA%\fujinet-go-atari2600 and are
  ; deliberately left behind: an uninstall should not throw away someone's
  ; configuration, key bindings or the SD folder they imported cartridges
  ; into, and a reinstall picks it straight back up.
SectionEnd
