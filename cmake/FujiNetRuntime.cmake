...
# (Stella's CartridgeFUJI + FujiNetLink, staged into core/stella-generated). FujiNet *listens* here (the RS232 bus's
...
if(WITH_FUJINET OR EXISTS "${FUJINET_LIB}")
  if(WIN32)
    ...
    install(FILES "${FUJINET_LIB}"
            DESTINATION ${CMAKE_INSTALL_LIBDIR}/fujinet-go-atari2600)
    install(FILES "${FUJINET_OUT}/fnconfig.ini"
            DESTINATION ${CMAKE_INSTALL_DATADIR}/fujinet-go-atari2600/fujinet)
    install(DIRECTORY "${FUJINET_OUT}/data" "${FUJINET_OUT}/SD"
            DESTINATION ${CMAKE_INSTALL_DATADIR}/fujinet-go-atari2600/fujinet)
  endif()
elseif(NOT WIN32)
